...
const INTRO_DURATION = 3200; // total intro length in ms
...
function RStarLogo({ className = '' }) {
 ...
 {/* Yellow gradient for the square to give it a premium feel */}
 <linearGradient id="yellowSquare" x1="0%" y1="0%" x2="0%" y2="100%">
 ...
 <rect x="20" y="20" width="160" height="160" rx="30" fill="url(#yellowSquare)" />
 </g>

 {/* Black R — bold geometric style */}
 <text
 x="65"
 y="145"
 ...
 {/* White ★ Star — positioned at bottom-right of R */}
 <polygon
 points="148,110 152.6,120.1 163,121.8 155.5,129.5 157.3,140 148,135 138.7,140 140.5,129.5 133,121.8 143.4,120.1"
 fill="#ffffff"
 />
 </svg>
 );
...
export default function CinematicIntro({ onComplete }) {
 ...
 useEffect(() => {
 // Phase 1: Logo fades in (0 – 1000ms)
 // Phase 2: Glow pulse & hold (1000 – 2200ms)
 // Phase 3: Fade out (2200 – 3200ms)

 const glowTimer = setTimeout(() => setPhase('glow'), 1000);
