...
export function ParallaxSection({ children, className = '', speed = 0.15, id }) {
 ...
 <div className="absolute inset-0 bg-gradient-to-b from-primary/[0.015] via-transparent to-gta-orange/[0.015] opacity-50" />
 </motion.div>
...
export const revealVariants = {
 ...
 duration: 0.8,
 delay: i * 0.12,
 ease: [0.16, 1, 0.3, 1], // Custom AAA ease-out
 },
 }),
};
