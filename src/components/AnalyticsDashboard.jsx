...
function StatCard({ label, value, icon, delay = 0 }) {
  return (
    ...
    >
      ...
      <p className="font-display font-black text-2xl sm:text-3xl text-gta-orange text-glow-sm tabular-nums">
  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 left-6 z-50 w-12 h-12 rounded-full glass-card flex items-center justify-center text-gta-orange hover:bg-gta-orange/20 hover:shadow-[0_0_25px_rgba(255,106,0,0.3)] transition-all duration-300 cursor-pointer"
      ...
      <AnimatePresence>
        {isOpen && stats && (
          <motion.div
            ...
            className="fixed bottom-20 left-6 z-50 w-[340px] sm:w-[380px] max-h-[70vh] overflow-y-auto rounded-2xl bg-gta-black/95 backdrop-blur-2xl border border-gta-orange/20 shadow-[0_0_60px_rgba(0,0,0,0.8),0_0_20px_rgba(255,106,0,0.1)]"
          >
            {/* Header */}
            <div className="sticky top-0 z-10 bg-gta-black/95 backdrop-blur-xl px-5 py-4 border-b border-gta-border/30 flex items-center justify-between">
              ...
              <button
                ...
                className="text-gta-muted hover:text-gta-orange transition-colors cursor-pointer"
            ...
            <div className="p-5 space-y-4">
              ...
              >
                ...
                <p className="font-display font-black text-xl text-gta-orange tabular-nums">
                  ...
                  <div className="space-y-1.5">
                    {stats.topTrailers.map(([name, count]) => (
                      <div key={name} className="flex items-center justify-between text-xs">
                        ...
                        <span className="text-gta-orange font-bold tabular-nums">{count}</span>
                      </div>
                    ))}
                  </div>
                </motion.div>
